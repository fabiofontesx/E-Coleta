...
const Detail: React.FC = () => {
  ...
  useEffect(() => {
    api.get<Data>(`points/${routeParams.point_id}`)
      .then(response => {
  ...
  function handleWhatsAppCompose(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse na coleta de itens`);
  }
  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <View style={styles.footer}>
        <RectButton style={styles.button} onPress={handleWhatsAppCompose}> 
